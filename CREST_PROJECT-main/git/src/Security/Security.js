            ...
            <div className="row row-no-gutters">
                <div id="navbar2" className="col-2 col-no-gutters">  
                    ...
                    <hr id="saperation"/>
                        ...
                        <li className="nav_list_contents option_cursor" onClick={() => history.push('/Products')}>
                    ...
                    <div className="row row-no-gutters security_info">
                        <div className="col-6 col-no-gutters security_info_first_half">
                            ...
                            <div className="row row-no-gutters">
                                ...
                                <button type="button" className="btn btn-primary button_01" onClick={this.handleShow} >C3I Nodes</button>
                                <button type="button" className="btn btn-primary button_01" onClick={this.handleShow1}>Possible Attack Paths</button>
                            </div>
